...
export default function Homepage() {
  const features = [
    ...
    },
    {
      ...
      description: "Send and receive money in real-time, 24/7, with zero delays."
    },
    {
      icon: <TrendingUp className="h-8 w-8" />,
      title: "Smart Insights",
      description: "Track spending patterns and get personalized financial advice."
    },
    {
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link to="/signup" className="bg-gradient-to-r from-blue-600 to-blue-700 text-white px-6 py-2 rounded-full hover:shadow-lg transform hover:scale-105 transition">
                Get Started
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Experience the future of banking with instant transfers, zero fees, and powerful financial tools at your fingertips.
              </p>
              ...
              <div className="flex items-center space-x-6 pt-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Rated 4.9 by 10K+ users</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="relative bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 rounded-3xl p-8 shadow-2xl transform rotate-3 hover:rotate-0 transition duration-500">
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 space-y-4">
                  ...
                  <div className="text-4xl font-bold text-white">$12,458.50</div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-white border border-gray-200 rounded-2xl p-6 hover:shadow-xl hover:border-blue-300 transition group">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {services.map((service, index) => (
              <div key={index} className="bg-white rounded-2xl p-8 hover:shadow-xl transition group">
                <div className={`bg-gradient-to-br ${service.color} w-12 h-12 rounded-xl flex items-center justify-center text-white mb-4 group-hover:scale-110 transition`}>
                  {service.icon}
                </div>
                <h3 className="text-2xl font-semibold text-gray-900 mb-2">{service.title}</h3>
                <p className="text-gray-600 mb-4">{service.description}</p>
                <a href="#" className="text-blue-600 font-medium flex items-center space-x-2 group-hover:space-x-3 transition-all">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-blue-100 text-sm mt-4">No credit card required • Set up in 2 minutes</p>
        </div>
      </section>
